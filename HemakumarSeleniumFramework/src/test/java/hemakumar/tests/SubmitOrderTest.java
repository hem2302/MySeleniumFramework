...
public class SubmitOrderTest extends BaseTest {
	...
	public void OrderHistoryTest() {
		// "ZARA COAT 3";
		ProductCatalogue productCatalogue = landingPage.loginApplication("hemakumar.1986@gmail.com", "Hema2302*");
	...
	public Object[][] getData() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				System.getProperty("user.dir") + "//src//test//java//hemakumar//data//PurchaseOrder.json");
